...
#질문 디렉토리 생성
questions = {
    "1.평소 본인이 감성적이라고 생각하시나요?": {"매우 그러함": 5, "조금 그러함": 4, "보통임": 3, "조금 아님": 2, "매우 아님": 1},
    "2.계획을 하고 행동하는 편인가요?": {"매우 그러함": 5, "조금 그러함": 4, "보통임": 3, "조금 아님": 2, "매우 아님": 1},
    "3.과학적 원리를 이해하는 것이 재미있나요?": {"매우 그러함": 1, "조금 그러함": 2, "보통임": 3, "조금 아님": 4, "매우 아님": 5},
    "4.방 정리하는 것을 즐기는 편인가요?": {"매우 그러함": 5, "조금 그러함": 4, "보통임": 3, "조금 아님": 2, "매우 아님": 1},
    "5.답이 여러 개인 문제를 한 개인 문제보다 선호하시나요?": {"매우 그러함": 5, "조금 그러함": 4, "보통임": 3, "조금 아님": 2, "매우 아님": 1},
    "6.갑자기 생긴 약속을 즐기는 편인가요?": {"매우 그러함": 1, "조금 그러함": 2, "보통임": 3, "조금 아님": 4, "매우 아님": 5},
    "7.비문학보다 소설을 읽는 것을 더 좋아하시나요?": {"매우 그러함": 5, "조금 그러함": 4, "보통임": 3, "조금 아님": 2, "매우 아님": 1},
    "8.다이어리를 꾸준히 쓰는 편인가요?": {"매우 그러함": 5, "조금 그러함": 4, "보통임": 3, "조금 아님": 2, "매우 아님": 1},
    "9.정의가 다음 중 무엇이라고 생각하시나요?": {"justice": 4, "definition": 2},
    "10.평소 창의적이라는 말을 자주 듣나요?": {"매우 그러함": 1, "조금 그러함": 2, "보통임": 3, "조금 아님": 4, "매우 아님": 5},
    "11.본인이 논리적이라고 생각하시나요?": {"매우 그러함": 1, "조금 그러함": 2, "보통임": 3, "조금 아님": 4, "매우 아님": 5},
    "12.일이 계획대로 되지 않으면 큰 불안감을 느끼나요?": {"매우 그러함": 5, "조금 그러함": 4, "보통임": 3, "조금 아님": 2, "매우 아님": 1},
    "13.평소 수학 문제 푸는 것을 즐기시나요?": {"매우 그러함": 1, "조금 그러함": 2, "보통임": 3, "조금 아님": 4, "매우 아님": 5},
    "14.공부할 때 본인이 좋아하는 부분부터 하는 경향이 있나요?": {"매우 그러함": 1, "조금 그러함": 2, "보통임": 3, "조금 아님": 4, "매우 아님": 5},
    "15.5!이 다음 중 무엇이라고 생각하시나요?": {"오!": 4,"5팩토리얼": 2},
    "16.미래를 통제하고 싶어하나요?": {"매우 그러함": 5, "조금 그러함": 4, "보통임": 3, "조금 아님": 2, "매우 아님": 1},
    "17.통합사회와 통합과학 중 어떤 과목에 더 자신이 있나요?": {"통합사회": 4, "통합과학": 2, "둘 다 자신 있음": 3, "줄 다 자신 없음": 3},
    "18.사물함 정리가 잘 되어있는 편인가요?": {"매우 그러함": 5, "조금 그러함": 4, "보통임": 3, "조금 아님": 2, "매우 아님": 1},
    "19.이육사가 다음 중 무엇이라고 생각하시나요?": {"시인": 4, "264": 2},
    "20.항상 일정한 시간에 일어나고 잠드는 편인가요?": {"매우 그러함": 5, "조금 그러함": 4, "보통임": 3, "조금 아님": 2, "매우 아님": 1}
}
...
if st.button("결과 확인하기"):
    ...
    if final_score1 >= 30: #점수에 따라서 유형 나누기
        result = 'L'
    else:
        result = 'N'
    st.text("")
